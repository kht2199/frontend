...
export const categoryColumns: ColDef<CategoryRecord>[] = [
	...
	{ field: "categoryType", headerName: "Category Type", flex: 1, minWidth: 130 },
	{ field: "categoryCode", headerName: "Category Code", flex: 1, minWidth: 130 },
...
export const propertyColumns: ColDef<PropertyRecord>[] = [
	...
	{ field: "value", headerName: "Value", flex: 1.5, minWidth: 200, editable: true },
];
...
export const detailColumns: ColDef<DetailRecord>[] = [
	...
	{ field: "value", headerName: "값", flex: 1.5, minWidth: 200, editable: true },
	{ field: "remark", headerName: "비고", flex: 1, minWidth: 150, editable: true },
];
